...
import { TYPES, ViewableBuffer, utils, settings, ENV, Geometry, Buffer, ObjectRenderer, Shader } from 'pixi.js';
...
var AttributeRedirect = /** @class */ (function (_super) {
    ...
    function AttributeRedirect(source, glslIdentifer, type, size, glType, glSize, normalize) {
        ...
        if (glType === void 0) { glType = TYPES.FLOAT; }
    ...
    AttributeRedirect.vertexSizeFor = function (attributeRedirects) {
        return attributeRedirects.reduce(function (acc, redirect) {
            return (ViewableBuffer.sizeOf(redirect.type)
                * redirect.properSize)
                + acc;
        }, 0);
    };
...
var BatchRenderer = /** @class */ (function (_super) {
    ...
    BatchRenderer.generateCompositeGeometry = function (attributeRedirects, hasIndex, textureAttribute, texturePerObject) {
        ...
        var attributeBuffer = new Buffer(null, false, false);
        var indexBuffer = hasIndex ? new Buffer(null, false, true) : null;
...
var ShaderGenerator = /** @class */ (function () {
    ...
    ShaderGenerator.prototype._generateShader = function (stringState) {
        ...
        var shader = Shader.from(vertexShaderTemplate, fragmentShaderTemplate, this._uniforms);
...
export { AttributeRedirect, BatchGenerator, BatchRenderer, BatchRendererPluginFactory, GeometryPacker, Redirect, ShaderGenerator };
