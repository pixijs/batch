...
var BatchRendererPluginFactory = function () {
  ...
  (0, _createClass2["default"])(BatchRendererPluginFactory, null, [{
    key: "from",
    value: function from(attributeRedirects, indexProperty, vertexCountProperty, textureProperty, texturePerObject, textureAttribute, stateFunction, shaderFunction, packer, BatchGeneratorClass) {
      var BatchRendererClass = arguments.length > 10 && arguments[10] !== undefined ? arguments[10] : _BatchRenderer.BatchRenderer;
      return function (_BatchRendererClass) {
        (0, _inherits2["default"])(_class, _BatchRendererClass);

        function _class(renderer) {
          (0, _classCallCheck2["default"])(this, _class);
          return (0, _possibleConstructorReturn2["default"])(this, (0, _getPrototypeOf2["default"])(_class).call(this, renderer, attributeRedirects, indexProperty, vertexCountProperty, textureProperty, texturePerObject, textureAttribute, stateFunction, shaderFunction, packer, BatchGeneratorClass));
        }
