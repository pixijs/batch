...
var CompilerConstants = {
  ...
  packerArguments: ['targetObject', 'compositeAttributes', 'compositeIndices', 'aIndex', 'iIndex', 'textureId']
};
...
var GeometryPacker = function () {
  ...
  (0, _createClass2["default"])(GeometryPacker, [{
    ...
    value: function pack(targetObject, textureId) {
      var deltaVertices = this.packerFunction(targetObject, this._targetCompositeAttributeBuffer, this._targetCompositeIndexBuffer, this._aIndex, this._iIndex, textureId);
    ...
    get: function get() {
      if (!this._packerFunction) {
        this._packerFunction = new GeometryPacker.FunctionCompiler(this).compile();
      }
...
(0, _defineProperty2["default"])(GeometryPacker, "FunctionCompiler", function () {
  function _class(packer) {
