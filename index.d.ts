...
declare interface IAttributeRedirectOptions {
    source: string | ((db: PIXI_2.DisplayObject) => any);
    attrib: string;
    type: string;
    size?: number | '%notarray%';
    glType: number;
...
declare interface IUniformRedirectOptions {
    source: string | ((displayObject: PIXI_2.DisplayObject) => any);
    uniform: string;
}
...
export declare abstract class Redirect {
    ...
    constructor(source: string | ((displayObject: PIXI_2.DisplayObject) => any), glslIdentifer: string);
}
